...
- **多模态工具：** 深入应用 **ComfyUI / Seedance / 可灵** 进行内容创作，开发 **AI 智能体 (AI Agents)**。
- 积极探索 **Gemini Veo3** 等前沿大模型在视频生成领域的应用。
- **自媒体 IP 运营：** 独立搭建抖音+小红书双平台二次元动漫 IP 矩阵。依托 AIGC (Gemini, ComfyUI等) 构建从角色设计、剧本分镜到 AI 视频生成的全链路标准化工作流，实现1个月高效涨粉5000+高粘性垂直粉丝，内容生产效率提升 80%。

**详细工作经历：**
1. **上海合阔信息技术有限公司 (2016.04 - 2025.07)**
   - **职位:** SaaS平台大客户总监 / 项目经理 / 高级开发
   - **大客户总监 (2023-2025):** 
     - **负责品牌:** **喜茶、乐乐茶、Something For、Seesaw、T9、久久丫**等。
