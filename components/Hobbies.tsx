    ...
    <section id="hobbies" className="py-20 px-4 relative overflow-hidden transition-colors duration-500">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Hobby 1: Gundam */}
          <div className="group relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden hover:border-blue-800 dark:hover:border-blue-400 transition-all duration-500">
            <div className="h-48 bg-slate-50 dark:bg-slate-800 flex items-center justify-center transition-colors relative overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2 group-hover:text-blue-800 dark:group-hover:text-blue-400 transition-colors">{t.gunplaTitle}</h3>
          ...
          {/* Hobby 2: Football */}
          <div className="group relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden hover:border-green-500 transition-all duration-500">
             <div className="h-48 bg-slate-50 dark:bg-slate-800 flex items-center justify-center transition-colors relative overflow-hidden">
          ...
          {/* Hobby 3: Short Video */}
          <div className="group relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden hover:border-pink-500 transition-all duration-500">
             <div className="h-48 bg-slate-50 dark:bg-slate-800 flex items-center justify-center transition-colors relative overflow-hidden">
